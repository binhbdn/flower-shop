<template>
  <div class="services__tab__details__form">
    ...
    <form action="#">
      <div class="row">
        ...
        <div class="col-lg-12 text-center">
          <textarea
            class="form-control"
            placeholder="Nội dung yêu cầu báo giá"
          ></textarea>
          <button type="submit" class="btn-florist btn-outline-florist">
            Gửi yêu cầu báo giá
          </button>
        </div>
      </div>
